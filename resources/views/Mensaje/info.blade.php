...
@section('contenido')
    <div class="w-full min-h-[20rem] h-[100vh] flex flex-col justify-center items-center">
        <h1 class="w-11/12 max-w-[30rem] rounded-lg h-20 bg-[#333] text-green-400 font-semibold flex justify-center items-center p-4 grid grid-cols-6">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-auto w-7 text-green-400 mr-1 col-span-1">
